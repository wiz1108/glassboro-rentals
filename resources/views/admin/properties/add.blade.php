        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <form id="add_pr" class="form-horizontal" method="post" action="{{url('admin/add-properties')}}"
                        id="lys_form" accept-charset='UTF-8'>
                        {{ csrf_field() }}
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1"
                                    class="control-label col-sm-3">{{trans('messages.property.home_type')}}</label>
                                <div class="col-sm-6">
                                ...
                                @if ($errors->has('property_type_id')) <p class="error-tag">
                                    {{ $errors->first('property_type_id') }}</p> @endif
                            </div>

                            <div class="form-group none">
                                <label for="exampleInputEmail1"
                                    class="control-label col-sm-3">{{trans('messages.property.room_type')}}</label>
                                ...
                                @if ($errors->has('space_type')) <p class="error-tag">{{ $errors->first('space_type') }}
                                </p> @endif
                            </div>
                            <div class="form-group none">
                                <label for="exampleInputEmail1"
                                    class="control-label col-sm-3">{{trans('messages.property.accommodate')}}</label>
                                <div class="col-sm-6">
                                    <select name="accommodates" class="form-control">
                                        @for($i=1;$i<=16;$i++) <option class="accommodates"
                                ...
                                @if ($errors->has('accommodates')) <p class="error-tag">
                                    {{ $errors->first('accommodates') }}</p> @endif
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1"
                                    class="control-label col-sm-3">{{trans('messages.property.city')}} <span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="map_address" name="map_address"
                                        placeholder="">
                                </div>
                                @if ($errors->has('map_address')) <p class="error-tag">
                                    {{ $errors->first('map_address') }}</p> @endif
                                <div id="us3"></div>
                            </div>
                        </div>
            ...
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="signup_form" method="post" name="signup_form"
                        ...
                        {{csrf_field()}}
                        <div class="form-group">
                            <label for="exampleInputPassword1" class="control-label col-sm-3">First Name<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1" class="control-label col-sm-3">Last Name<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            <label for="Password" class="control-label col-sm-3">Password<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-8">
            ...
            success: function(result) {
                if (result == 'not_unique') {
                    $('#emailError').html('<label class="text-danger">' +
                        "{{ __('messages.jquery_validation.email_existed') }}" + '</label>');
...
function updateControls(addressComponents) {
    ...
    if (typeof(addressComponents.city) !== 'undefined' && addressComponents.country !== 'undefined' && typeof(
            addressComponents.city) !== null && addressComponents.country !== null && typeof(addressComponents.city) !==
        ...
        $.ajax({
            ...
            .done(function(response) {
                if (response.status == 1) {
                    ...
                    $('#host_id').append('<option data-icon-class="icon-star-alt" value="' + response.user
                        .id + '" selected="selected">' + response.user.first_name + ' ' + response.user
                        .last_name + '</option>');
                    $('#signup_form')[0].reset();
                }
            })
