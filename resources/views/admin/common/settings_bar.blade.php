<div class="box box-info box_info">
    <div class="panel-body">
        ...
        <ul class="nav navbar-pills nav-tabs nav-stacked no-margin" role="tablist">
            ...
            <li class="{{ (Route::current()->uri() == 'admin/settings/sms') ? 'active' : ''  }} none">
            ...
            <li
                class="{{ (Route::current()->uri() == 'admin/settings/starting-cities') || (Route::current()->uri() == 'admin/settings/add-starting_cities') || (Route::current()->uri() == 'admin/settings/edit-starting-cities/{id}') ? 'active' : ''  }}">
            ...
            <li
                class="{{ (Route::current()->uri() == 'admin/settings/space-type' || Route::current()->uri() == 'admin/settings/add-space-type' || Route::current()->uri() == 'admin/settings/edit-space-type/{id}') ? 'active' : ''  }} none">
            ...
            <li
                class="{{ (Route::current()->uri() == 'admin/settings/bed-type' || Route::current()->uri() == 'admin/settings/add-bed-type'|| Route::current()->uri() == 'admin/settings/edit-bed-type/{id}') ? 'active' : ''  }} none">
            ...
            <li
                class="{{ (Route::current()->uri() == 'admin/settings/currency' || Route::current()->uri() == 'admin/settings/add-currency' || Route::current()->uri() == 'admin/settings/edit-currency/{id}') ? 'active' : ''  }} none">
            ...
            <li
                class="{{ (Route::current()->uri() == 'admin/settings/country' || Route::current()->uri() == 'admin/settings/add-country' || Route::current()->uri() == 'admin/settings/edit-country/{id}') ? 'active' : ''  }} none">
            ...
            <li class="{{ (Route::current()->uri() == 'admin/settings/email') ? 'active' : ''  }} none">
                <a href="{{ url('admin/settings/email') }}">Email Settings</a>
            </li>
            @endif

            @if(Helpers::has_permission(Auth::guard('admin')->user()->id, 'manage_fees'))
            <li class="{{ (Route::current()->uri() == 'admin/settings/fees') ? 'active' : ''  }} none">
            ...
            <li
                class="{{ (Route::current()->uri() == 'admin/settings/language' || Route::current()->uri() == 'admin/settings/add-language' || Route::current()->uri() == 'admin/settings/edit-language/{id}') ? 'active' : ''  }} none">
            ...
            <li
                class="{{ (Route::current()->uri() == 'admin/settings/metas' || Route::current()->uri() == 'admin/settings/edit_meta/{id}') ? 'active' : ''  }} none">
            ...
            <li class="{{ (Route::current()->uri() == 'admin/settings/api-informations') ? 'active' : ''  }} none">
            ...
            <li class="{{ (Route::current()->uri() == 'admin/settings/payment-methods') ? 'active' : ''  }} none">
            ...
            <li
                class="{{ (Route::current()->uri() == 'admin/settings/roles' || Route::current()->uri() == 'admin/permissions' || Route::current()->uri() == 'admin/settings/add-role' || Route::current()->uri() == 'admin/settings/edit-role/{id}') ? 'active' : ''  }} none">
            ...
            <li class="{{ (Route::current()->uri() == 'admin/backup') ? 'active' : ''  }} none">
