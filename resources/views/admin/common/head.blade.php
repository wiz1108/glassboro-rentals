	...
	<head>
	    ...
	    <link rel="stylesheet"
	        href="{{URL::to('/')}}/public/backend/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
	    ...
	    <link rel="stylesheet"
	        href="{{URL::to('/')}}/public/backend/plugins/DataTables-1.10.18/css/jquery.dataTables.min.css">
	    <link rel="stylesheet"
	        href="{{URL::to('/')}}/public/backend/plugins/Responsive-2.2.2/css/responsive.dataTables.min.css">
	    <!--Select2-->

	    <link rel="stylesheet" type="text/css"
	        href="{{ asset('public/js/intl-tel-input-13.0.0/build/css/intlTelInput.css')}}">
