	                                    ...
	                                    <div class="col-md-12 col-sm-12 col-xs-12">
	                                        ...
	                                        <div class="col-md-3 col-sm-12 col-xs-12">
	                                            ...
	                                            <select class="form-control" name="status" id="status">
	                                                ...
	                                                <option value="Active"
	                                                    {{ $allstatus == "Active" ? ' selected="selected"' : '' }}>Active
	                                                </option>
	                                        ...
	                                        <div class="col-md-3 col-sm-12 col-xs-12">
	                                            ...
	                                            <select class="form-control select2" name="customer" id="customer">
	                                                ...
	                                                <option
	                                                    value="{{$customer->id}}" "{{ $customer->id == $allcustomers ? ' selected="selected"' : ''}}">
	            ...
	            <div class="col-xs-12">
	                <div class="box">
	                    <div class="box-header">
	                        ...
	                        <div class="pull-right"><a class="btn btn-success" href="{{ url('admin/add-customer') }}">Add
	                                Customer</a></div>
	                        @endif
	                    </div>
