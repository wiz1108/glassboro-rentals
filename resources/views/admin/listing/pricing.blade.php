...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-9">
                <form id="listing_pricing" method="post" action="{{url('admin/listing/'.$result->id.'/'.$step)}}"
                    ...
                    <div class="box box-info">
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <label for="listing_price_native" class="label-large">Monthly Price <span
                                            class="text-danger">*</span></label>
                                    <div class="input-addon">
                                        <span class="input-prefix pay-currency">{!!
                                            $result->property_price->currency->org_symbol !!}</span>
                                        <input type="text" data-suggested="" id="price-night"
                                            ...
                                            name="price" class="money-input form-control">
                                    </div>
                                ...
                                <div class="col-md-8 none">
                                    ...
                                    <select id='price-select-currency_code' name="currency_code" class='form-control'>
                                        ...
                                        <option value="{{$key}}"
                                            {{$result->property_price->currency_code == $key?'selected':''}}>{{$value}}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-8 none">
                                    ...
                                    $result->property_price->monthly_discount == 0)
                                    <p id="js-set-long-term-prices"
                                        class="row-space-top-6 text-center text-muted set-long-term-prices">
                                        {{trans('messages.listing_price.access_offer')}} <a data-prevent-default=""
                                            href="#"
                                            id="show_long_term">{{trans('messages.listing_price.week_month')}}</a>
                            ...
                            <div class="row none {{ ($result->property_price->weekly_discount == 0 && $result->property_price->monthly_discount == 0)? 'display-off':''}}"
                                id="long-term-div">

                                <div class="col-md-8">
                                    <label for="listing_price_native"
                                        class="label-large">{{trans('messages.listing_price.week_price')}}</label>
                                    <div class="input-addon">
                                        <span class="input-prefix pay-currency">{!!
                                            $result->property_price->currency->org_symbol !!}</span>
                                ...
                                <div class="col-md-8">
                                    <label for="listing_price_native"
                                        class="label-large">{{trans('messages.listing_price.monthly_price')}}</label>
                                    <div class="input-addon">
                                        <span class="input-prefix pay-currency">{!!
                                            $result->property_price->currency->org_symbol !!}</span>
                                ...
                                <div class="col-md-12">
                                    <label for="listing_cleaning_fee_native_checkbox" class="label-large label-inline">
                                        <input type="checkbox" data-extras="true" class="pricing_checkbox"
                                            data-rel="cleaning"
                                            {{($result->property_price->original_cleaning_fee == 0)?'':'checked="checked"'}}>&nbsp
                                        ...
                                        <div class="col-md-4 l-pad-none">
                                            <div class="input-addon">
                                                ...
                                                <input type="text" data-extras="true" id="price-cleaning"
                                                    ...
                                                    name="cleaning_fee" class="money-input"
                                ...
                                <div class="col-md-12">
                                    <label for="listing_cleaning_fee_native_checkbox" class="label-large label-inline">
                                        <input type="checkbox" class="pricing_checkbox" data-rel="additional-guests"
                                            {{($result->property_price->original_guest_fee == 0)?'':'checked="checked"'}}>&nbsp
                                        ...
                                        <div class="col-md-4 l-pad-none">
                                            <div class="input-addon">
                                                ...
                                                <input type="text" data-extras="true"
                                                    ...
                                                    id="price-extra_person" name="guest_fee" class="money-input"
                                                    data-saving="additional-saving">
                                            </div>
                                        </div>
                                        <div class="col-md-4 txt-right">
                                            <label
                                                class="label-large">{{trans('messages.listing_price.guest_after')}}</label>
                                        </div>
                                        <div class="col-md-4">
                                            <select id="price-select-guests_included" name="guest_after"
                                                data-saving="additional-saving" class="form-control">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-4 l-pad-none">
                                            <div class="input-addon">
                                                <span class="input-prefix pay-currency">{!!
                                                    $result->property_price->currency->org_symbol !!}</span>
                                                <input type="text" class="money-input" data-extras="true"
                                        ...
                                        <div class="col-md-4 l-pad-none">
                                            <div class="input-addon">
                                                ...
                                                <input type="text" data-extras="true"
                                                    ...
                                                    id="price-weekend" name="weekend_price" class="money-input"
                                                    data-saving="additional-saving">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row mt-30">
                                <div class="col-md-6 col-xs-6 text-left">
                                    <a data-prevent-default="" href="{{ url('admin/listing/'.$result->id.'/photos') }}"
