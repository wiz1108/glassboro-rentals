                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" value="{{$result->bedrooms}}" name="bedrooms"
                                        id="basics-select-bedrooms" data-saving="basics1" class="form-control"
                                        required />
                                </div>
                                <div class="col-md-4 none">
                                    <label class="label-large">{{trans('messages.listing_basic.bed')}}</label>
                                    <input type="number" value="{{$result->beds}}" name="beds" id="basics-select-beds"
                                        data-saving="basics1" class="form-control" />
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <select name="bathrooms" id="basics-select-bathrooms" data-saving="basics1"
                                        class="form-control">
                                        @for($i=0.5;$i<=11;$i+=0.5) <option class="bathrooms" value="{{ $i }}"
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <select name="property_type" data-saving="basics1" class="form-control">
                                        ...
                                        <option value="{{ $key }}"
                                            {{ ($key == $result->property_type) ? 'selected' : '' }}>{{ $value }}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-4 none">
                                    ...
                                    <select name="space_type" data-saving="basics1" class="form-control">
                                        ...
                                        <option value="{{ $key }}"
                                            {{ ($key == $result->space_type) ? 'selected' : '' }}>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-4 none">
                                    ...
                                    <select name="accommodates" id="basics-select-accommodates" class="form-control">
                                        @for($i=1;$i<=16;$i++) <option class="accommodates" value="{{ $i }}"
