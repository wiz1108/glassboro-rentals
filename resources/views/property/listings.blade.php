                    ...
                    <div class="row">
                        <div class="col-md-12 p-0 mb-3">
                            <div class="list-bacground mt-4 rounded-3 p-4 border">
                                <span
                                    class="text-18 pt-4 pb-4 font-weight-700">{{trans('messages.listing_basic.listing')}}</span>
                                            ...
                                            <form action="{{ url('/properties') }}" method="POST" id="listing-form">
                                                ...
                                                <select class="form-control text-center text-14 minus-mt-6"
                                                    ...
                                                    <option value="All"
                                                        ...
                                                        {{trans('messages.filter.all')}}</option>
                                                    <option value="Listed"
                                                        {{ @$status == "Listed" ? ' selected="selected"' : '' }}>
                                                        {{trans('messages.property.listed')}}</option>
                                                    <option value="Unlisted"
                                                        {{ @$status == "Unlisted" ? ' selected="selected"' : '' }}>
                                                        {{trans('messages.property.unlisted')}}</option>
                                                </select>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 col-xl-6 p-2">
                                    ...
                                    <div class="review-0 mt-4">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="pr-5">
                                                <span class="font-weight-700 text-20">{!! moneyFormat(
                                                    $property->property_price->currency->symbol,
                                                    $property->property_price->price) !!}</span> /
                                                {{trans('messages.property_single.night')}}</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="list-inline mt-2 pb-3">
                                        <li class="list-inline-item border rounded-3 p-1 mt-4 pl-3 pr-3 none">
                                            <p class="text-center mb-0">
                                                ...
                                                <span
                                                    class=" text-14 font-weight-700">{{trans('messages.property_single.bed')}}</span>
                                            </p>
                                        </li>
                                        <li class="list-inline-item  border rounded-3 mt-4 p-1  pl-3 pr-3">
                                            <p class="text-center mb-0">
                                                ...
                                                {{ $property->bedrooms }}
                                                <span
                                                    class=" text-14 font-weight-700">{{trans('messages.property_single.guest')}}</span>
                                            </p>
                                        </li>
                                        <li class="list-inline-item  border rounded-3 mt-4 p-1  pl-3 pr-3">
                                            <p class="text-center mb-0">
                                                ...
                                                {{ $property->bathrooms }}
                                                <span
                                                    class="text-14 font-weight-700">{{trans('messages.property_single.bathroom')}}</span>
                                            </p>
                                        </li>
                                    </ul>
                                </div>
                                                ...
                                                <div class="col-6 col-sm-12">
                                                    <div class="main-toggle-switch text-left text-sm-center">
                                                        ...
                                                        <span
                                                            ...
                                                            {{trans('messages.property.step_listed')}}</span>
                                                        @endif
                                                    </div>
                                                </div>
